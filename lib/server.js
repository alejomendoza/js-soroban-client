  ...
  _createClass(Server, [{
    ...
    value: function () {
      var _getAccount = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(address) {
        var _data$entries;
        var ledgerKey, data, ledgerEntries, ledgerEntryData, accountEntry;
      ...
      var _simulateTransaction = _asyncToGenerator(_regeneratorRuntime().mark(function _callee9(transaction) {
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return jsonrpc.post(this.serverURL.toString(), "simulateTransaction", transaction.toXDR()).then(function (raw) {
